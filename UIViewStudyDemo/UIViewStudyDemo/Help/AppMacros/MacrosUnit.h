...
#define SetTextBackItem  SetBackItemTitle(@"")

#define SetBackItemWithImageName(imageName) [self.navigationItem setBackBarButtonItem:[[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:imageName] style:(UIBarButtonItemStylePlain) target:nil action:nil]]
#define SetImageBackItem SetBackItemWithImageName(@"icon_back_h")
